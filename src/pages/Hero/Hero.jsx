...
const profile = {
    ...
    skills: [
        ...
        'MySQL', 'MongoDB', 'Docker', 'AWS', 'TypeScript', 'Git', 'Linux', 'Discord Development'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Full-Stack & AI-Driven Developer 🤖 | Building Intelligent Web Experiences with ASP.NET Core, MySQL & Gemini API 🚀
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                {/* Contact Button */}
                <a
                  href="/Apoorv_Pandey_Resume.pdf"
                  download="Apoorv_Pandey_Resume.pdf"
